...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-01-2020 a las 22:54:06
...
CREATE TABLE `almacenamientos` (
  ...
  `name_corto` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL,
  `location` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `color` varchar(11) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci COMMENT='los datos están en la tabla operation en array id=indice ';
...
CREATE TABLE `sell` (
  ...
  `status_delivery` tinyint(2) DEFAULT NULL COMMENT 'muestra el estado de la entrega de productos 1= entrega completa  0=no hay entrega 2=entrega a media',
...
(2, 'FOAMTCK SAS', '', '1', '2020-01-16 13:01:49');
