<?php $user = CategorycData::getById($_GET["idc"]);?>
<div class=" ">
  <div class="box-header with-border">
    <h3 class="box-title">Editar Categoria # <?php echo $_GET["idc"]; ?></h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  <form class="form-horizontal">
    ...
    <div class="box-footer">
      ...
      <a  class=" btn btn-info pull-right" onclick="updatecategoryc()">Actualizar Categoria</a>
    </div>
    <!-- /.box-footer -->
  </form>
</div>
