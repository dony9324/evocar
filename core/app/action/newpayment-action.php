  ...
  <div class="modal-dialog modal-lg"> <!-- tamaño del modal-->
    ...
    <div  class="box box-success fondo">
      <div class="box-header with-border">
        ...
        <!-- form start -->
        <div class="box-body">
          <form id="searchp" class="form-horizontal" autocomplete="off">
            <div class="form-group">
              <div id="contenedorname">
                <label for="name"  class="col-sm-4 control-label">Buscar Credito codigo:</label>
                <div class="col-sm-6">
                  <input type="hidden" name="view" value="payment">
                  <div class="input-group input-group-sm">
                    <input type="number" min="0" id="product_code" name="sell" class="form-control" placeholder="Codigo" autofocus>
          ...
          <form id="searchp2" class="form-horizontal" autocomplete="off">
            <div class="form-group">
              <div id="contenedornamecorto">
                <label for="namecorto" class="col-sm-4 control-label">Buscar Cliente nombre, cedula o por codigo:</label>
                <div class="col-sm-6">
                  <div class="input-group input-group-sm">
                    <input type="hidden" name="view" value="payment">
                    <input type="text" id="product_code2" name="clients" class="form-control" placeholder="Cliente">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-info btn-flat">Buscar</button>
                    </span>
                  </div>
          ...
          function elegir2(valor){
            console.log("elegir cliente"+valor);
            $.get("./?action=searchpayment2",{
              cc: valor
            },function(data){
              $("#show_search_results").html(data);
            });
        ...
        <form method="post" class="form-horizontal" name="processpayment" id="processpayment" action="index.php?action=processpayment" >
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input  type="text" name="money" required class="money form-control" id="money" placeholder="Efectivo">
            </div>
          </div>
