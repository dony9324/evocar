        ...
        <button id="bclose" type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">
          ...
          <div class="box-body">
            ...
            <td class="<?php if(isset($client -> name) && $credit->person_id!="" ): else: echo 'danger'; endif; ?>"><?php if(isset($client -> name) && $credit->person_id!=""):
            	...
            	<td><b>$ <?php $total3=$credit->total; echo number_format((($credit->total - $q)/100),2,',','.'); ?></b></td>
                <td><b>$ <?php echo number_format(($q/100),2,',','.'); ?></b></td>
             ...
             <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="money" required class="form-control" id="money" placeholder="Efectivo">
            		...
            		<a href="index.php?action=clearcart2" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
                    <button class="btn btn-success"><i class="glyphicon glyphicon-usd"></i> Finalizar Pago</button>
