...
class CuentasData {
	...
	public function add(){
		$sql = "insert into Cuentas (name,name_corto,location,color,user_id,created_at) ";
		$sql .= "value (\"$this->name\",\"$this->name_corto\",\"$this->location\",\"$this->color\",\"$this->user_id\",$this->created_at)";
		Executor::doit($sql);
	}

	public function add_with_image(){
		$sql = "insert into Cuentas (name,name_corto,location,image,color,user_id,created_at) ";
