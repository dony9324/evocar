<section class="content-header">
  <h1><i class="fa fa-user"></i> Clientes <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="#" onClick="changerview('./?page=home')"><i class="fa fa-home"></i> Inicio</a></li>
    <li class="active"><a href="#" onClick="changerview('./?page=clients')">Clientes</a></li>
  </ol>
</section>
<!-- Main content -->
      ...
      <div class="box">
        <div class="box-header">
          ...
          <div class="btn-group pull-right">
            <button type="button" id="btnnewclient" onclick="newclient()" class="btn btn-default"><i class="fa  fa-plus"></i><i class='fa fa-user'></i> Nuevo Cliente</button>
            <div class="btn-group pull-right">
              <?php $u=null;
