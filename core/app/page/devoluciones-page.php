<section class="content-header">
  <h1><i class='fa  fa-exchange'></i>Devoluciones<small></small></h1>
  <ol class="breadcrumb">
    <li onclick="changerview('./?page=home')"><a href="#"><i class="fa fa-home"></i> inicio</a></li>
  <li class="active"><a href="#" onClick="changerview('./?page=devoluciones')">Devoluciones</a></li>
  </ol>
</section>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button type="button" id="btnnewdevolucion" onclick="newdevolucion()" class="btn btn-default"><i class="fa  fa-plus"></i>Nueva Devolución</button>
        ...
        function newdevolucion(){
          ...
          $.get("./?action=newdevolucion",function(data){
            $("#newdevolucipn").html(data);
            $('#myModal').modal('show');
            $("#btnnewdevolucion").prop('disabled', false);
          });
        }
        </script>
      </br>
