...
<?php foreach($operations as $operation):?>
	<tr>
		...
		<td><?php if (isset($operation->getProduct()->name)){echo $operation->getProduct()->name;}else{echo "ERROR productto eliminado";} ?></td>
		<td><?php echo $operation->q; ?></td>
		<td><?php if($operation->operation_type_id == 1) {echo "Entrada";}else if($operation->operation_type_id == 2) { echo "Salida";} ?></td>
