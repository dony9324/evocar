      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button type="button" id="btnnewuser" onclick="newuser()" class="btn btn-default"><i class="fa fa-plus"></i><i class='glyphicon glyphicon-user'></i> Nuevo usuario</button>
          </div>
        </div>
        <div id="newuser"> </div>

        <script>
        //esta funcion carga el formulario para guardar un nuevo user
        function newuser(){
          ...
          $.get("./?action=newuser",function(data){
            $("#newuser").html(data);
            $('#myModal').modal('show');
