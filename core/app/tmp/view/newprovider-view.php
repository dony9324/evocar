<div class="row">
	...
	<br>
		<form class="form-horizontal" method="post" enctype="multipart/form-data"  id="addproduct" action="index.php?action=addprovider" role="form" >
...
<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-info">Agregar Proveedor</button>
    </div>
  </div>
</form>
	</div>
