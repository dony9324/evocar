<div class="row">
	<div class="col-md-12">
	<a href="index.php?action=addproduct" class="btn btn-info pull-right">Agregar Producto</a>
...
<br><table style="width:100%;" class="table table-bordered table-hover">
	...
	<tr>
		...
		<td>
		<a href="index.php?view=productreport&id=<?php echo $product->id; ?>" class="btn btn-info"><i class="glyphicon glyphicon-eye-open"></i> Ver Reporte</a>
		</td>
	</tr>
	<?php endforeach;?>
</table>
