...
<div class="row">
  ...
  <?php setcookie("prdupd","",time()-18600); endif; ?>
	<br><br>
		<form class="form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?action=updateproduct" role="form" >
...
<?php if($product->image!=""):?>
  <br>
        <img src="res/products/<?php echo $product->image;?>" class="img-responsive">
...
<?php endif;?>
  ...
  <div class="form-group">
    <label  class="col-lg-3 control-label">Codigo de barras*</label>
    <div class="col-md-8">
    ...
    <option value="<?php $cate = NULL; if($product->category_id!=null){ $cate = CategoryData::getById($product->category_id); 
	echo $product->category_id;} ?>">
	<?php if(count ($cate)){ echo $cate->name;} else 
	{ echo "-- NINGUNA --";}?></option>
  ...
  <div class="form-group">
    <label  class="col-lg-3 control-label">Precio de Entrada*</label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label  class="col-lg-3 control-label">Precio de Salida*</label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label  class="col-lg-3 control-label">Minima en inventario:</label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label  class="col-lg-3 control-label" >Esta activo</label>
    <div class="col-md-8">
<div class="checkbox">
    <label>
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="product_id" value="<?php echo $product->id; ?>">
      <button type="submit" class="btn btn-success">Actualizar Producto</button>
        <a style=" height:35px; " href="index.php?view=editproduct&id=<?php $i=1;  
		  $products = ProductData::getAll2();
		  foreach($products as $product){
				$q= ($product->id);
				}
		if($q >= ($i + $_GET["id"])){
			$productnext = ProductData::getById($_GET["id"]+ $i);
	  while($productnext == null ){   $i++;
	  $productnext = ProductData::getById($_GET["id"]+$i);
	     } echo $_GET["id"]+$i;  } else { echo $_GET["id"];  }?>"
               class="btn btn-xs btn-success">
        <i class="glyphicon glyphicon-time"></i> <?php if($q <= ($i-1 + $_GET["id"])){ echo " Ultimo ".$_GET["id"]; }else {echo "Siguiente";}?> </a> 
  </div>
</form>
