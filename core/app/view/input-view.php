...
<br><form class="form-horizontal" method="post" action="index.php?action=processinput" role="form" >
   <div class="form-group">
    <label  class="col-lg-2 control-label">Unidad</label>
    <div class="col-lg-10">
      <input type="text" value="<?php echo $product->unit; ?>" readonly class="form-control" id="inputEmail1" placeholder="Cantidad de productos">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-info"glyphicon glyphicon-circle-arrow-up"></i> Alta en inventario</button>
    </div>
  </div>
</form>
	</div>
