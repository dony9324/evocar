				...
				<div class="center-block">
					<ul class="users-list clearfix">
						<?php while($r = $query->fetch_array()){ ?>
							<li onclick="foco(<?php echo $r['id'];?>)" data-toggle="modal" data-target="#myModal<?php echo $r['id'];?>">
												...
												<div style="width:90%;" class="lockscreen-item">
													...
													<form id="loginForm<?php echo $r['id'];?>" class="lockscreen-credentials" method="post" action="./?action=access&o=login" autocomplete="off">
														<div class="input-group">
															<input type="password" id="pas<?php echo $r['id'];?>" class="form-control"  placeholder="Contraseña" name="password" autofocus>
...
function foco(id){
console.log("foco");
setTimeout(function(){ $("#pas1").focus(); console.log("foco2"); }, 300);
