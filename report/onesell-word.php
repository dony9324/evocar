...
$table1->addCell(9000)->addText($sell->id." ");
...
$table2->addCell(1000)->addText("P.Unidad");
...
$section1->addText("");
$section1->addText("SubTotal: $".number_format($total,2,".",","),array("size"=>20));
$section1->addText("Decuento: $".number_format($discount,2,".",","),array("size"=>20));
$section1->addText("iva: $".number_format(($total-$discount)*$infoiva/100,2,".",","),array("size"=>20));
$section1->addText("Total: $".number_format($total-$discount,2,".",","),array("size"=>20));
